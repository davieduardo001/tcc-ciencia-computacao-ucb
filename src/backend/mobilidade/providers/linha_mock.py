...
#
# ATENÇÃO: os números aqui (0.110, 0.108) existem de verdade no DF, mas
# com trajeto totalmente diferente — a 0.110 real é a circular
# Rodoviária/UnB. Este mock é só rede de segurança pra quando a tabela
# `linha` ainda não foi populada (ver mobilidade/ingestao_semob.py, que
# traz as 923 linhas reais do SEMOB). Não use estes dados como verdade.
